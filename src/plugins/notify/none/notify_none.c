/*****************************************************************************\
 *  notify_none.c - NO-OP notifier plugin.
 *****************************************************************************
 ...
 */
const char plugin_name[]       	= "NONE notify plugin";
const char plugin_type[]       	= "notify/none";
 ...
 */
int slurm_notify_log (uint16_t state, void *arg)
{
	return SLURM_SUCCESS;
}
